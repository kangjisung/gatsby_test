...
const NavbarStyleSeven = () => {
    ...
    return (
        <>
            <div id="navbar" className="navbar-area dibiz-new-navbar-area-style-two">
                                ...
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        ...
                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="nav-item">
                                                <Link to="/index-8" activeClassName="active" onClick={toggleNavbar} className="nav-link">
                                                    Home Demo - 8 <span>New</span>
                                                </Link>
                                            </li>

                                            <li className="nav-item">
                                                <Link to="/index-9" activeClassName="active" onClick={toggleNavbar} className="nav-link">
                                                    Home Demo - 9 <span>New</span>
                                                </Link>
                                            </li>

                                            <li className="nav-item">
                                                <Link to="/index-10" activeClassName="active" onClick={toggleNavbar} className="nav-link">
                                                    Home Demo - 10 <span>New</span>
                                                </Link>
                                            </li>
                                        </ul>
                                    </li>
...
export default NavbarStyleSeven;